...
const NotificationSetting = () => {
  ...
  const mapApiToState = (apiData) => ({
    push: apiData.smsReminder || false, // Assuming smsReminder maps to push notifications
    email: apiData.enableFailedPaymentAlerts || false, // Assuming this maps to email
    sms: apiData.smsReminder || false, // SMS alert maps to smsReminder
    shipment: apiData.shipmentAndLoad || false,
    payments: apiData.payment || false,
    accounts: apiData.accountsAndUserActivity || false,
    reports: apiData.reportsAndInsights || false,
    compliance: apiData.complianceAndSafety || false,
    optional: apiData.optionalAdvancedToggle || false,
  });
  ...
  useEffect(() => {
    const fetchNotificationSettings = async () => {
      try {
        setLoading(true);
        const response = await apiService.getNotificationPrivacy();
        if (response) {
          setToggles(mapApiToState(response));
        }
      } catch (err) {
